...
function sensei_certificate_template_admin_enqueue_scripts() {
	...
	if ( in_array( $screen->id, array( 'certificate_template' ), true ) ) {
		...
		wp_enqueue_script( 'sensei_certificate_templates_admin', $woothemes_sensei_certificates->plugin_url . 'assets/dist/js/admin.js', array( 'jquery' ), SENSEI_CERTIFICATES_VERSION );
	...
	if ( in_array( $screen->id, array( 'course' ), true ) ) {
		...
		wp_enqueue_script( 'sensei_course_certificate_templates_admin', $woothemes_sensei_certificates->plugin_url . 'assets/dist/js/course.js', array( 'jquery' ), SENSEI_CERTIFICATES_VERSION );
