...
/**
 * Sensei Certificates List Table Class
 *
 * All functionality pertaining to the Certificates Data Table Class.
 *
 * @package WordPress
 * @subpackage Sensei
 * @category Core
 ...
 * - bulk_actions()
 */
class WooThemes_Sensei_Certificates_List_Table extends WP_List_Table {
	public $token;
	public $columns;
	...
	public function __construct () {
		...
		$this->columns = array(
			'certificate_learner' => __( 'Learner', 'woothemes-sensei-certificates' ),
			'certificate_course' => __( 'Course', 'woothemes-sensei-certificates' ),
			'certificate_course_completed' => __( 'Date Completed', 'woothemes-sensei-certificates' ),
			'certificate_actions' => __( 'Certificates', 'woothemes-sensei-certificates' )
		);
		// Sortable Columns
		$this->sortable_columns = array(
			'certificate_learner' => array( 'certificate_learner', false ),
			'certificate_course' => array( 'certificate_course', false ),
			'certificate_course_completed' => array( 'certificate_course_completed', false )
		);
		$this->per_page = 10;
		parent::__construct(
			array(
